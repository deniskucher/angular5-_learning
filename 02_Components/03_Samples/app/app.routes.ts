...
import { BookComponent, CounterHostComponent, TimerHostComponent, NameCardHostComponent, MessageBoxHostComponent, MyTableHostComponent } from "./01_components/index";
...
export const routes: Routes = [
    ...
    { path: "my-table", component: MyTableHostComponent }
];